...
from sampleworks.utils.grid_search_utils import save_losses, save_trajectory
from sampleworks.utils.guidance_script_utils import parse_rf3_pure_guidance_args
...
if __name__ == "__main__":
    args = parse_rf3_pure_guidance_args()
    main(args)
