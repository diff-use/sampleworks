...
class PureGuidance:
    ...
    def sample(
        ...
        # Two-phase rewards need the model atom array, which only exists now.
        # No-op for rewards that do not implement prepare().
        prepare_reward_if_needed(reward, processed_structure, device=coords.device)
